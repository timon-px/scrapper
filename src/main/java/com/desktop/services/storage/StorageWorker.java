...
public class StorageWorker implements IStorageWorker {
    ...
    @Override
    public CompletableFuture<Path> SaveToFolderAsync(String content, Path folderPath, String fileName) {
    ...
    public CompletableFuture<String> SaveFileAsync(String url, FileSaveModel fileSaveModel, Path mainPath) {
        try {
            ...
            Path filePath = PathHelper.GetPath(fileType, mainPath.toString()).resolve(fileName);
    ...
    @Override
    public String GetUniqueFileName(Path folderPath, String fileName) {
        Path filePath = folderPath.resolve(fileName);
        ...
        do {
            ...
            counter++;
        } while (Files.exists(folderPath.resolve(uniqueFileName)));
